...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_NAME":"Moniu","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/***/ 40:
/*!************************************************************************!*\
  !*** D:/Documents/MoNiu/Moniu/uni_modules/js_sdk/u-qrcode/u-qrcode.js ***!
  \************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
(function () {
  ...
  function Queue() {_classCallCheck(this, Queue);
    var waitingQueue = [];
    var isRunning = false; //记录是否有未完成的任务
  ...
  /**
          ...
          */
  uQRCode.deepReplace = function () {var o = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};var r = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  ...
  uQRCode.getLoadImage = function (loadImage) {
    if (typeof loadImage == 'function') {
      return function (src) {
        ...
        return uQRCode.QueueLoadImage(function () {return new Promise(function (resolve, reject) {
            setTimeout(function () {
              var cache = uQRCode.loadImageCache.find(function (x) {return x.src == src;});
              if (cache) {
                resolve(cache.img);
              } else {
  ...
  uQRCode.prototype = {
    ...
    /**
                     * 获取制作二维码数据
                     */
    getMakeData: function getMakeData() {var _this$options =




      this.options,typeNumber = _this$options.typeNumber,errorCorrectLevel = _this$options.errorCorrectLevel,text = _this$options.text;
    ...
    /**
        ...
        */
    make: function make() {
      var makeData = this.makeData = this.getMakeData();
    ...
    paintData: function paintData() {
      ...
      var moduleCount = this.moduleCount;var _this$options2 =
      ...
      this.options,size = _this$options2.size,margin = _this$options2.margin,background = _this$options2.background,foreground = _this$options2.foreground,useDynamicSize = _this$options2.useDynamicSize;
      ...
      var dynamicSize = this.options.dynamicSize = Math.ceil((size - margin * 2) / moduleCount) * moduleCount + margin * 2; // Math.ceil向上取整缩放效果比floor清晰
      if (!useDynamicSize) {
        dynamicSize = this.options.dynamicSize = size;
      }
      var tileSize = (dynamicSize - margin * 2) / moduleCount;
    ...
    paintPositionDetection: function paintPositionDetection() {
      var modules = this.modules;
      var size = this.moduleCount;var

      positionDetection =
      this.options.positionDetection;
      ...
      var disc = size - 7; //size -7
      basePart.forEach(function (d) {
    ...
    paintSeparator: function paintSeparator() {
      var modules = this.modules;
      var size = this.moduleCount;var
    ...
    paintAlignment: function paintAlignment() {
      var modules = this.modules;
      var size = this.moduleCount;var _this$options3 =



      this.options,alignment = _this$options3.alignment,typeNumber = _this$options3.typeNumber;
      ...
      if (alignments) {
        ...
        for (var _i = 0; _i < group_len; _i++) {var _loop = function _loop(
          j) {
            //对齐图案不能污染 定位器和分隔器
            var _x$y =
            ...
            {
              x: alignments[_i],
              y: alignments[j] },x = _x$y.x,y = _x$y.y;

            if (!(x < 9 && y < 9 || x > size - 9 - 1 && y < 9 || y > size - 9 - 1 && x < 9)) {
              calcMatrix.forEach(function (d) {
            ...
            }};for (var j = 0; j < group_len; j++) {_loop(j);
          }
        }
      }
    },

    paintTiming: function paintTiming() {
      var modules = this.modules;var

      timing =
      this.options.timing;

      var timingPartLen = modules.length - 16;
      for (var _i2 = 0; _i2 < timingPartLen; _i2++) {
        var xItem = modules[6][8 + _i2];
        var yItem = modules[8 + _i2][6];
        xItem.type.push('timing');
        yItem.type.push('timing');
        xItem.color = 1 & _i2 ^ 1 ? timing.foregroundColor : timing.backgroundColor;
        yItem.color = 1 & _i2 ^ 1 ? timing.foregroundColor : timing.backgroundColor;
      }
    },

    paintDarkBlock: function paintDarkBlock() {
      var modules = this.modules;
      var size = this.moduleCount;var

      darkBlock =
      this.options.darkBlock;
    ...
    paintVersionInformation: function paintVersionInformation() {
      var modules = this.modules;
      var size = this.moduleCount;var _this$options4 =



      this.options,versionInformation = _this$options4.versionInformation,version = _this$options4.typeNumber;
      ...
      var version_codes = VERSIONS[version] + VERSIONS[version];
      //创建预留版本信息
      var disc = [size - 11, size - 10, size - 9];
      // 左+右
      var version_cells = [
      //左
      [5, disc[2]],
      ...
      version_cells.forEach(function (d, index) {
    ...
    /**
        * 绘制二维码方法
        */
    draw: function draw(options) {var _this = this;
      ...
      return new Promise(function (resolve, reject) {
        ...
        var startup = function startup() {
          ...
          return uQRCode.Queue(function () {return new Promise(function (queueResolve, queueReject) {
              setTimeout(function () {
        ...
        then(function () {
          /* 绘制背景图片 */
          return _this.drawBackgroundImage({
        ...
        then(function () {
          /* 绘制前景图片 */
          return _this.drawForegroundImage({
    ...
    drawBackground: function drawBackground(_ref)


    {var _this2 = this;var before = _ref.before,after = _ref.after;var _this$options5 =



      this.options,size = _this$options5.dynamicSize,background = _this$options5.background;
      ...
      return new Promise(function (resolve, reject) {
        _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.next = 2;return (
                  ...
                  _context.next = 9;return (
                    after(_this2));case 9:
                  resolve();case 10:case "end":return _context.stop();}}}, _callee);}))();

      });
    },

    drawBackgroundImage: function drawBackgroundImage(_ref3)


    {var _this3 = this;var before = _ref3.before,after = _ref3.after;var _this$options6 =



      this.options,size = _this$options6.dynamicSize,background = _this$options6.background;
      var ctx = this.canvasContext;

      return new Promise(function (resolve, reject) {
        _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2() {var x, y, w, h, align, anchor, alpha, img;return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:_context2.next = 2;return (
                    before(_this3));case 2:if (!

                  background.image.src) {_context2.next = 38;break;}
                  ctx.save();

                  x = 0;
                  y = 0;

                  w = background.image.width * size;
                  h = background.image.height * size;
                  align = background.image.align;
                  anchor = background.image.anchor;
                  alpha = background.image.alpha;_context2.t0 =

                  align[0];_context2.next = _context2.t0 ===
                  'left' ? 14 : _context2.t0 ===


                  'center' ? 16 : _context2.t0 ===


                  'right' ? 18 : 20;break;case 14:x = 0;return _context2.abrupt("break", 20);case 16:x = size / 2 - w / 2;return _context2.abrupt("break", 20);case 18:
                  x = size - w;return _context2.abrupt("break", 20);case 20:


                  x += Number(anchor[0]);_context2.t1 =

                  align[1];_context2.next = _context2.t1 ===
                  'top' ? 24 : _context2.t1 ===


                  'center' ? 26 : _context2.t1 ===


                  'bottom' ? 28 : 30;break;case 24:y = 0;return _context2.abrupt("break", 30);case 26:y = size / 2 - h / 2;return _context2.abrupt("break", 30);case 28:
                  y = size - h;return _context2.abrupt("break", 30);case 30:
                  ...
                  /* 绘制图片 */_context2.next = 34;return (
                    _this3.loadImage(background.image.src));case 34:img = _context2.sent;
                  ctx.drawImage(img, x, y, w, h);
                  ctx.restore();
                  ctx.draw(true); // gcanvas需要每一阶段都draw一下，否则重绘有问题，例如uni-app nvue绘制图片会失败
                case 38:_context2.next = 40;return (

                    after(_this3));case 40:
                  resolve();case 41:case "end":return _context2.stop();}}}, _callee2);}))();

      });
    },

    drawForeground: function drawForeground(_ref5)


    {var _this4 = this;var before = _ref5.before,after = _ref5.after;var
      ...
      return new Promise(function (resolve, reject) {
        _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee3() {var rowI, colI, tile, color;return _regenerator.default.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:_context3.next = 2;return (
                    before(_this4));case 2:

                  ctx.save();
                  for (rowI = 0; rowI < moduleCount; rowI++) {
                    for (colI = 0; colI < moduleCount; colI++) {
                      tile = modules[rowI][colI];
                  ...
                  _context3.next = 8;return (
                    after(_this4));case 8:
                  resolve();case 9:case "end":return _context3.stop();}}}, _callee3);}))();

      });
    },

    drawForegroundImage: function drawForegroundImage(_ref7)


    {var _this5 = this;var before = _ref7.before,after = _ref7.after;var _this$options7 =



      this.options,size = _this$options7.dynamicSize,foreground = _this$options7.foreground;
      var ctx = this.canvasContext;

      return new Promise(function (resolve, reject) {
        _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee4() {var x, y, w, h, align, anchor, alpha, shadow, border, img;return _regenerator.default.wrap(function _callee4$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:_context4.next = 2;return (
                    before(_this5));case 2:if (!

                  foreground.image.src) {_context4.next = 39;break;}
                  ctx.save();
                  ...
                  w = foreground.image.width * size;
                  h = foreground.image.height * size;
                  align = foreground.image.align;
                  anchor = foreground.image.anchor;
                  alpha = foreground.image.alpha;
                  shadow = foreground.image.shadow;
                  border = foreground.image.border;_context4.t0 =

                  align[0];_context4.next = _context4.t0 ===
                  'left' ? 16 : _context4.t0 ===


                  'center' ? 18 : _context4.t0 ===


                  'right' ? 20 : 22;break;case 16:x = 0;return _context4.abrupt("break", 22);case 18:x = size / 2 - w / 2;return _context4.abrupt("break", 22);case 20:
                  x = size - w;return _context4.abrupt("break", 22);case 22:


                  x += Number(anchor[0]);_context4.t1 =

                  align[1];_context4.next = _context4.t1 ===
                  'top' ? 26 : _context4.t1 ===


                  'center' ? 28 : _context4.t1 ===


                  'bottom' ? 30 : 32;break;case 26:y = 0;return _context4.abrupt("break", 32);case 28:y = size / 2 - h / 2;return _context4.abrupt("break", 32);case 30:
                  y = size - h;return _context4.abrupt("break", 32);case 32:


                  y += Number(anchor[1]);

                  /* 绘制图片 */_context4.next = 35;return (
                    _this5.loadImage(foreground.image.src));case 35:img = _context4.sent;
                  ctx.drawImage(img, x, y, w, h);
                  ctx.restore();
                  ctx.draw(true); // gcanvas需要每一阶段都draw一下，否则重绘有问题，例如uni-app nvue绘制图片会失败
                case 39:_context4.next = 41;return (

                    after(_this5));case 41:
                  resolve();case 42:case "end":return _context4.stop();}}}, _callee4);}))();
...
/***/ 5:
/*!*******************************************!*\
  !*** D:/Documents/MoNiu/Moniu/pages.json ***!
  \*******************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 56:
/*!***************************************************************!*\
  !*** D:/Documents/MoNiu/Moniu/uni_modules/uni-icons/icons.js ***!
  \***************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
